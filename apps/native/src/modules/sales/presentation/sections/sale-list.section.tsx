...
import { FindAllSalesFilters } from "@fludge/client/application/sales/domain/sale.repository";
...
export function SalesListSection({
  ...
  const { data, fetchNextPage, hasNextPage } = useFindSales(filters ?? {});
...
export function SalesListSectionSkeleton() {
  return (
    <View className="gap-y-3">
