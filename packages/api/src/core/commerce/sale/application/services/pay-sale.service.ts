import type { Sale } from "@core/commerce/sale/domain/entities/sale.entity";
import type { SalePayment } from "@core/commerce/sale/domain/entities/sale-payment.entity";
