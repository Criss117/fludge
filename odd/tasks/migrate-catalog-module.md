...
1. [x] Copiar entity (imports @fludge/api/core), 2 exceptions (imports @fludge/api/core), value objects si aplica
...
6. [x] Copiar entities (product, product-presentation, collection), VOs (status, stock), 11 exceptions (imports @fludge/api/core, typo bresentation corregido en nombre de archivo)
